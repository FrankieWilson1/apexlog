    ...
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6">
      <div className="w-full max-w-sm flex flex-col gap-6">
        ...
        <div className="text-center">
          ...
          <p className="text-muted text-sm">Ready to crush another workout?</p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full bg-primary text-white font-bold py-4 rounded-xl flex items-center justify-center gap-2 active:scale-95 transition-all disabled:opacity-60"
          >
            {isLoading ? (
